...
## 20240913
Разработать программу для записи в sqlite-базу данных списка студентов группы. При запуске программа должна давать возможность 
ввести определённое количество студентов. Хранимые данные: ФИО и день рождения. Что и как вводить должно быть понятно пользователю
